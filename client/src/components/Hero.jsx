  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          {profile.name} — {profile.role} shipping full-stack products with{" "}
          <span className="text-paper">secure auth</span>,{" "}
          <span className="text-paper">optimized databases</span>, and{" "}
          <span className="text-paper">interfaces people enjoy using</span>.
        </motion.p>
        ...
        >
          <a
            ...
            className="group relative px-6 py-3 rounded-lg bg-signal text-ink font-medium overflow-hidden transition-transform hover:-translate-y-0.5"
          >
            View my work
          </a>
          <a
